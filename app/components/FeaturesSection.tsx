        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, idx) => (
            <motion.div
              ...
              className="group relative overflow-hidden border border-white/10 bg-black/40 hover:border-amber-500/50 transition-all duration-300"
            >
              <div className="p-10">
                <feature.icon className="text-amber-500 mb-6" size={40} />
                <span className="text-white/40 text-xs font-medium tracking-[0.3em] uppercase mb-4 block">
                  {feature.subtitle}
                </span>
