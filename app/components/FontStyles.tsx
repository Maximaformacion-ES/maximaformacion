...
export const FontStyles = () => (
  <style>{`
    @font-face { font-family: 'ZTNature'; src: url('${fonts.thin}') format('opentype'); font-weight: 100; font-style: normal; }
    @font-face { font-family: 'ZTNature'; src: url('${fonts.thinItalic}') format('opentype'); font-weight: 100; font-style: italic; }
    @font-face { font-family: 'ZTNature'; src: url('${fonts.light}') format('opentype'); font-weight: 300; font-style: normal; }
    @font-face { font-family: 'ZTNature'; src: url('${fonts.regular}') format('opentype'); font-weight: 400; font-style: normal; }
    @font-face { font-family: 'ZTNature'; src: url('${fonts.medium}') format('opentype'); font-weight: 500; font-style: normal; }
    @font-face { font-family: 'ZTNature'; src: url('${fonts.bold}') format('opentype'); font-weight: 700; font-style: normal; }
    @font-face { font-family: 'ZTNature'; src: url('${fonts.black}') format('opentype'); font-weight: 900; font-style: normal; }
    @font-face { font-family: 'ZTNature'; src: url('${fonts.blackItalic}') format('opentype'); font-weight: 900; font-style: italic; }
