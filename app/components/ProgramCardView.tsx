...
/**
 * Tarjeta de programa presentacional, SIN Clerk. Recibe `userHasPro` como prop.
 * Así puede usarse:
 *   - desde <ProgramCard> (envoltorio con Clerk) en las rutas de app, con el
 *     estado Pro real del usuario, y
 *   - desde la home/marketing (CoursesSection) con `userHasPro={false}`, sin
 *     cargar Clerk (el visitante anónimo ve precio de lista + "Ahorras X con Pro").
 */
