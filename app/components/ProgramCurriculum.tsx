...
export const ProgramCurriculum: React.FC<ProgramCurriculumProps> = ({ program }) => {
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          <p className="text-neutral-400 max-w-2xl mx-auto">
            Estructura completa del programa con {program.modules.length} módulos especializados
          </p>
        </motion.div>
            ...
            >
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-2">
                    <span className="text-amber-500 text-sm font-bold">Módulo {index + 1}</span>
                  ...
                  <p className="text-neutral-400 mt-2 font-light">{module.description}</p>
                </div>
                <motion.div
              ...
              <AnimatePresence>
                {expandedModule === index && (
                  ...
                  >
                    <div className="px-6 md:px-8 pb-6 md:pb-8 pt-4 border-t border-white/10">
