          ...
          <div className="min-w-0">
            ...
            >
              {post.author?.name && (
                <div className="flex items-center gap-3 text-mx-text">
                  ...
                  <div className="flex flex-col leading-tight">
                    ...
                    <span className="text-body-sm font-bold">{post.author.name}</span>
                  </div>
                </div>
              )}
              <div className="flex items-center gap-2.5 text-mx-text">
                ...
                <span className="text-body-sm font-bold">{formatDate(post.publishedAt)}</span>
              </div>
              <div className="flex items-center gap-2.5 text-mx-text">
                <Clock size={16} className="text-mx-orange" />
                <span className="text-label-sm uppercase tracking-widest text-mx-text-muted">Lectura</span>
                <span className="text-body-sm font-bold">{post.readTime}</span>
              </div>
            </m.div>
          </div>
