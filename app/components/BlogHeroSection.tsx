    ...
    <section ref={containerRef} className="relative h-dvh flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <m.h1
          ...
          className="text-display-sm md:text-display-md font-black text-mx-blue mb-6 md:mb-8 leading-tight"
        >
          {post.title}
        </m.h1>
        ...
        <m.p
          ...
          className="text-body-sm md:text-body-md xl:text-body-lg text-mx-text-muted font-light mb-8 md:mb-12 max-w-3xl mx-auto"
        >
          {post.excerpt}
        </m.p>
        ...
        >
          <div className="flex items-center gap-3 text-mx-text">
            ...
            <div className="text-left">
              <div className="text-label-sm md:text-label-md text-mx-text-muted uppercase tracking-widest">Publicado</div>
              <div className="text-body-sm md:text-body-md font-bold">{formatDate(post.publishedAt)}</div>
            </div>
          </div>
          <div className="flex items-center gap-3 text-mx-text">
            <Clock size={20} className="text-mx-orange" />
            <div className="text-left">
              <div className="text-label-sm md:text-label-md text-mx-text-muted uppercase tracking-widest">Tiempo de lectura</div>
              <div className="text-body-sm md:text-body-md font-bold">{post.readTime}</div>
            </div>
          </div>
        </m.div>
      </m.div>
