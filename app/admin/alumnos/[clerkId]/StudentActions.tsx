      ...
      <div className="flex flex-wrap items-end gap-4">
        <button
          ...
          className={`rounded-md px-4 py-2 text-sm font-medium disabled:opacity-50 ${
            isPro ? 'bg-zinc-800 text-zinc-200 hover:bg-zinc-700' : 'bg-amber-500 text-black hover:bg-amber-400'
          }`}
        >
        ...
        <div className="flex items-end gap-2">
          <div>
            ...
            <input
              ...
              className="w-72 rounded-md bg-zinc-900 border border-zinc-800 px-3 py-2 text-sm placeholder:text-zinc-600 focus:outline-none focus:border-zinc-600"
            />
          </div>
          <label className="flex items-center gap-1.5 text-xs text-zinc-400 pb-2.5">
          ...
          <button
            ...
            className="rounded-md bg-zinc-800 text-zinc-100 hover:bg-zinc-700 px-4 py-2 text-sm font-medium disabled:opacity-50"
          >
            {busy === 'grant' ? '…' : 'Conceder'}
          </button>
        </div>
      ...
      <section>
        ...
        <div className="rounded-lg border border-zinc-800">
          {enrollments.length === 0 ? (
            <p className="p-4 text-sm text-zinc-500">Sin matrículas.</p>
          ) : (
                ...
                <li key={e.documentId} className="p-3 flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-zinc-500">
                      ...
                      <span className="text-zinc-600"> · {e.documentId}</span>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="rounded-md border border-zinc-700 text-zinc-300 hover:bg-zinc-800 px-2.5 py-1.5 text-xs disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      className="rounded-md border border-red-500/40 text-red-300 hover:bg-red-500/10 px-2.5 py-1.5 text-xs disabled:opacity-50"
                    >
