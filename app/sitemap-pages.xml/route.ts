...
const PAGES: SitemapEntry[] = [
  ...
  { loc: '/cursos-universitarios/atencion-educativa-saac', changefreq: 'weekly', priority: 0.7 },
  { loc: '/cursos-universitarios/ia-exelearning', changefreq: 'weekly', priority: 0.6 },
  { loc: '/cursos-universitarios/h5p-ia', changefreq: 'weekly', priority: 0.6 },
