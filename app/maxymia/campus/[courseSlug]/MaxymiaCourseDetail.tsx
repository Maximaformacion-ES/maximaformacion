  ...
  return (
    <div>
      ...
      {/* Sellos de confianza ESPECÍFICOS de este curso (relación en Strapi).
          Diseño propio y compacto, distinto del mosaico de la home. */}
      <CourseTrustSeals badges={course.badges} locale={locale} />
...
// ─── Trust Seals (per-course) ───────────────────────────────────

function CourseTrustSeals({
  badges,
  locale,
}: {
