  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative p-2.5 rounded-full transition-colors hover:bg-black/[0.04]"
        aria-label="Notifications"
      >
        <Bell size={16} className="text-mx-text-muted" />
        {isLoaded && hasUnseen && (
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-[26rem] max-w-[calc(100vw-2rem)] rounded-xl overflow-hidden shadow-xl z-50 border bg-mx-card border-mx-border"
          >
            {/* Header */}
            <div className="px-4 py-3 border-b border-mx-border">
              <h3 className="text-body-sm font-medium text-mx-text">
            ...
            <div className="max-h-80 overflow-y-auto">
              {newCourses.length === 0 ? (
                <div className="px-4 py-8 text-center">
                  <Bell size={24} className="mx-auto mb-2 text-mx-text-muted/50" />
                ...
                newCourses.map((course, index) => (
                  ...
                  >
                    <Link
                      ...
                      className="flex items-center gap-3 px-4 py-3 transition-colors border-b last:border-b-0 hover:bg-black/[0.04] border-mx-border"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-body-sm font-medium truncate text-mx-text">
                          {course.title[locale]}
                        </p>
                        <p className="text-label-md mt-0.5 text-mx-text-muted">
