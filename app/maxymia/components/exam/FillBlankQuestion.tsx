          ...
          return (
            <div key={i} className="flex items-center gap-3">
              <input
                ...
                className={`flex-1 px-4 py-3 rounded-lg border text-body-sm text-mx-text bg-mx-card placeholder:text-mx-text-muted/60 focus:outline-none transition-colors ${
                  submitted
                    ? isCorrect
                      ? 'border-green-500/50 bg-green-500/10'
                      : 'border-red-500/50 bg-red-500/10'
                    : 'border-mx-border focus:border-mx-orange/60'
                }`}
              />
              {submitted && (
                isCorrect
                  ...
                  : (
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <span className="text-green-700 text-label-md">
