  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-amber-500/30 overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_80%,rgba(245,158,11,0.05),transparent_50%)]" />
        <div 
      ...
      >
        <div className="max-w-[1800px] mx-auto px-6 md:px-12 py-6">
          <div className="flex items-center justify-between">
            ...
            >
              ¿Ya tienes cuenta? <span className="text-amber-500">Inicia sesión</span>
            </Link>
          </div>
        </div>
      </motion.nav>
